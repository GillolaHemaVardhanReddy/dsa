...
class Employee : public AbstractEmployee { // Changed inheritance to public
   ...
   public:
    ...
    virtual void work(){
        cout<<" i am working or a company "<< endl;
    }
...
class Developer : public Employee { // Changed inheritance to public
    ...
    public: 
        ...
        /*
            in polymorphism we can change implementation of methods of parent cass
            in child class whithout changing the name of method or parameters
        */
